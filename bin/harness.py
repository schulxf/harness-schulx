...
def build_parser() -> argparse.ArgumentParser:
    ...
    dashboard_hub_config.add_argument("--default-cli", choices=["codex", "claude", "shell"])
    ...
    agent_register.add_argument("--cli", choices=["codex", "claude", "shell"])
